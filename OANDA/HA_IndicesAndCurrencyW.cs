    ...
    public class HA_IndicesAndCurrencyW
    {
        ...
        public static void Run()
        {
            ...
            foreach (Instrument instrument in instruments)
            {
                ...
                OANDA.Results.Get(instrument, ha_H1_LastCandle.Color.ToString(), ha_H4_LastCandle.Color.ToString(), ha_D_LastCandle.Color.ToString(), ha_W_Candles, instrumentWeeklyPrice);
     ...
     public   static List<Model.Candle> HA_W_Candles(Instrument instrument,out InstrumentDayPrice instrumentWeeklyPrice)
        {
            ...
            List<Model.Candle> candles = Data.Prices.GetCandles(instrument.Name, 22, "W");
            EMA ema = new EMA(22);
